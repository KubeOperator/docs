...
![gpu-host-detail](../img/guidelines/gpu_ai/gpu-host-detail.png)
...
![jupter-login](../img/guidelines/gpu_ai/tensorflow-login.png)
...
![jupter-terminal](../img/guidelines/gpu_ai/tensorflow-terminal.png)
