...
!!! info "定义：混合架构是指使用KubeOperator部署同时包含 x86_64 和 arm64 架构主机的 Kubernetes集群"   
    如下图所示，混合部署需要提供 x86_64 和 arm64 架构的 nexus 仓库，以便于集群部署时可以下载到对应架构到资源，之后在KubeOperator系统设置添加不同架构到仓库信息。</br>
