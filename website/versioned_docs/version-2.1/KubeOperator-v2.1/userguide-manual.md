...
![cluster-create-2](../../../img-2.1/cluster-manu-2.png)
...
![cluster-create-3](../../../img-2.1/cluster-manu-3.png)
...
![cluster-create-5](../../../img-2.1/cluster-manu-6.png)

#### 2.1.7 配置检测

完成上述 5 个步骤后，KubeOperator 会对当前集群所选择的部署节点进行配置检测，包含 CPU、内存和操作系统的检测。

![cluster-create-6](../../../img-2.1/cluster-manu-7new.png)
...
![cluster-expand-1](../../../img-2.1/cluster-expand-0.png)

确认后，会自动转到【任务】页面，实时查看扩容进度，完成后可以看到如下图所示信息。

![cluster-expand-2](../../../img-2.1/cluster-expand-5.png)
