---
id: version-2.1-userguide-openstack
...
![setting-1](../../../img-2.1/setting-system-openstack.png)
...
![zone-3](../../../img-2.1/zone-status-openstack.png)
...
![plan-1](../../../img-2.1/create-plan-openstack.png)

部署计划配置包括选择可用区（可用区可以单选或多选），并设置 Master 节点，Worker 节点的规格，即 CPU，内存和磁盘。

![plan-2](../../../img-2.1/creat-plan-openstack-conf.png)
...
![cluster-create-1](../../../img-2.1/cluster-openstack.png)
...
![cluster-create-2](../../../img-2.1/cluster-plan-openstack-1.png)
...
![cluster-create-5](../../../img-2.1/cluster-complete-openstack-1.png)
...
![cluster-deploy](../../../img-2.1/cluster-summary-openstack.png)

集群部署开始后，将会自动跳转到【任务】页。在【任务】页里可以看到集群部署当前所执行的具体任务信息。

![cluster-deploy-1](../../../img-2.1/cluster-install-openstack-1.png)


如果是内网环境的话，一个典型的 4 节点集群的部署大概需要10分钟左右的时间,【历史】页可以看到详情部署时间信息。在出现类似下图的信息后，表明集群已部署成功。

![cluster-deploy-2](../../../img-2.1/cluster-install-openstack-2.png)

【历史】页可以看到所有完成的任务详情信息，包括部署过程中的日志详情。

![cluster-deploy-3](../../../img-2.1/cluster-history-openstack.png)
...
![cluster-expand-1](../../../img-2.1/cluster-expand-openstack.png)
